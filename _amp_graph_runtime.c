...
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 52), // unsigned char const *
...
/* 12 */ _CFFI_OP(_CFFI_OP_POINTER, 50), // AmpGraphRuntime *
/* 13 */ _CFFI_OP(_CFFI_OP_POINTER, 51), // char const *
...
/* 26 */ _CFFI_OP(_CFFI_OP_POINTER, 47), // double * *
...
/* 36 */ _CFFI_OP(_CFFI_OP_FUNCTION, 53), // void()(AmpGraphControlHistory *)
/* 37 */ _CFFI_OP(_CFFI_OP_POINTER, 49), // AmpGraphControlHistory *
/* 38 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 39 */ _CFFI_OP(_CFFI_OP_FUNCTION, 53), // void()(AmpGraphRuntime *)
/* 40 */ _CFFI_OP(_CFFI_OP_NOOP, 12),
/* 41 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 42 */ _CFFI_OP(_CFFI_OP_FUNCTION, 53), // void()(AmpGraphRuntime *, double)
/* 43 */ _CFFI_OP(_CFFI_OP_NOOP, 12),
/* 44 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 14),
/* 45 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 46 */ _CFFI_OP(_CFFI_OP_FUNCTION, 53), // void()(double *)
/* 47 */ _CFFI_OP(_CFFI_OP_POINTER, 25), // double *
/* 48 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 49 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // AmpGraphControlHistory
/* 50 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 1), // AmpGraphRuntime
/* 51 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 2), // char
/* 52 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 4), // unsigned char
...
static void _cffi_d_amp_graph_runtime_set_dsp_sample_rate(AmpGraphRuntime * x0, double x1)
{
  amp_graph_runtime_set_dsp_sample_rate(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_amp_graph_runtime_set_dsp_sample_rate(PyObject *self, PyObject *args)
{
  AmpGraphRuntime * x0;
  double x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "amp_graph_runtime_set_dsp_sample_rate", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_amp_graph_runtime_set_dsp_sample_rate _cffi_d_amp_graph_runtime_set_dsp_sample_rate
#endif
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "amp_graph_runtime_buffer_free", (void *)_cffi_f_amp_graph_runtime_buffer_free, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 46), (void *)_cffi_d_amp_graph_runtime_buffer_free },
  ...
  { "amp_graph_runtime_set_dsp_sample_rate", (void *)_cffi_f_amp_graph_runtime_set_dsp_sample_rate, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 42), (void *)_cffi_d_amp_graph_runtime_set_dsp_sample_rate },
...
static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "AmpGraphControlHistory", 49, _CFFI_F_OPAQUE,
    (size_t)-1, -1, -1, 0 /* opaque */ },
  { "AmpGraphRuntime", 50, _CFFI_F_OPAQUE,
    (size_t)-1, -1, -1, 0 /* opaque */ },
};

static const struct _cffi_typename_s _cffi_typenames[] = {
  { "AmpGraphControlHistory", 49 },
  { "AmpGraphRuntime", 50 },
  { "uint32_t", 16 },
  { "uint8_t", 52 },
};
